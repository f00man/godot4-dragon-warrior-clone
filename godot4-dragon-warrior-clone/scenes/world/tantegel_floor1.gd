...
# Description: Root script for Tantegel Castle Floor 1 (ground floor / entrance
#              hall). This floor connects Floor 2 above to the overworld exit
#              below. Five guards and an old soldier populate the hall, and a
#              treasure chest holds an herb near the west wall.
#              Encounters are disabled — the castle interior is always safe.
# Attached to: Node2D (TantegelFloor1) in scenes/world/tantegel_floor1.tscn
# ==============================================================================
...
func _ready():
	...
	# This covers quest updates or story beats keyed to "tantegel_floor1" scene id.
	EventManager.check_events_for_scene("tantegel_floor1")
